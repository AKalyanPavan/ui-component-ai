					...
					<header>
						<div className="flex items-center justify-between">
							...
							<div className="font-['Lexend'] font-normal text-[14px] tracking-[3px] min-[900px]:block hidden">
								<Link href="/service"><span className="cursor-pointer hover:underline underline-offset-[5px] decoration-[2px]">WHAT WE DO</span></Link>
								<Link href="/work"><span className="xl:mx-[100px] cursor-pointer mx-[50px] cursor-pointer hover:underline underline-offset-[5px] decoration-[2px]">OUR WORK</span></Link>
